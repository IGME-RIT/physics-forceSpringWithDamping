/*
Title: Forces - Springs with Damping
File Name: main.cpp
Copyright © 2015
...
Description:
This is a demonstration of forces. It uses forces to simulate spring mechanics with damping.
...
void update(float dt)
{
	...
	//A spring force with damping is determined by:
	//	F = -k * dX - c * V
	//
	...
	//	dX = (X - O)
	//
	//And c is the damping constant, and V is the velocity
	//
	//Lets say that the origin of the spring system is the mouse position!
	//Let us calculate the spring force
	triangleBody->netForce = -k * (triangleBody->position - mousePos) - c * triangleBody->velocity;
...
void main()
{
	...
	// Create a window
	window = glfwCreateWindow(800, 800, "Forces - Springs with damping", nullptr, nullptr);
